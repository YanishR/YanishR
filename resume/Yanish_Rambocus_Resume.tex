...
\begin{rSection}{Profile}   
    Software Engineer since Aug '21 designing, developing and maintaining business systems deployed to Cloud Infrastructure.
    Recently focusing on the DevOps side of Engineering, having transitioned my team from manual deployments to an 
    automated IaC pipeline leveraging Pulumi, Github Actions and the Gradle/Kotlin ecosystem.
    ...
    \begin{tabular}{ @{\hspace{8mm}} l @{\hspace{13.5ex}} l }
        ...
        \vspace{1.1mm}
        \large{\caps{Cloud Providers}} & AWS, GCP, Kubernetes\\
        \vspace{1.1mm}
        \large{\caps{IaC \& CI/CD}} & Terraform, Pulumi, Github Actions, CircleCI\\
        \vspace{1.1mm}
        \large{\caps{Databases}} & PostgreSQL, DynamoDB\\
        \vspace{1.1mm}
        \large{\caps{Messaging Queues}} & Kafka, SQS, Google Pub/Sub\\
        \vspace{1.1mm}
        \large{\caps{Other Technologies}} & AWS ECS \& Lambda, Quarkus, Keycloak\\
    \end{tabular}
...
\begin{rSection}{Work Experience}
    ...
    \item Kickstarted AI-native testing tool with the implementation repository indexation with \texttt{CocoIndex}
    \item Transitioned team from manual K8s and AWS resource management to automated\\
        IaC pipelines for different environments
    \item Developed and maintained a Kubernetes observability agent that works out-of-the-box
    \item Ideated and created Docker and Helm installers for our Kubernetes observability agent
  \end{rSubsection}
  ...
  \begin{rSubsection}{So Energy}{Dec 21 - Nov 22}{Junior Backend Engineer}{London, UK}
    ...
    \item Managed microservices running on Kubernetes hosted on GCP
  \end{rSubsection}
