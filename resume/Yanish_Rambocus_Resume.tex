...
\begin{rSection}{Profile}   
    ...
    Recently, I have been focusing on the DevOps side of Engineering, transitioning my team
    from manual deployments to an automated IaC pipeline leveraging Pulumi, Github Actions and the Gradle/Kotlin ecosystem.
    ...
    \begin{tabular}{ @{\hspace{8mm}} l @{\hspace{13.5ex}} l }
        ...
        \vspace{1.1mm}
        \large{\caps{Cloud Resource Providers}} & AWS, GCP, Kubernetes\\
        \vspace{1.1mm}
        \large{\caps{Infrastructure-as-Code}} & Terraform, Pulumi\\
        \vspace{1.1mm}
        \large{\caps{CI/CD}} & Github Actions, CircleCI\\
        \vspace{1.1mm}
...
\begin{rSection}{Work Experience}
    ...
    \item Transitioned team from manual Kubernetes and AWS resource provisioning to automated\\
